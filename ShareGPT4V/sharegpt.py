...
from share4v.conversation import *
...
class Sharegpt(lmms):
    ...
    def __init__(
        self,
        pretrained: str = "Lin-Chen/ShareGPT4V-7B",
        ...
        **kwargs,
        ...
        super().__init__()
        print("Hi bro. I am a newly added model in lmms-eval!")
    ...
    def generate_until(self, requests: List[Instance]) -> List[str]:
        ...
        for chunk in chunks:
            ...
            try:
                ...
                text_outputs = self.tokenizer.batch_decode(cont[:, input_token_len:], skip_special_tokens=True)[0]
                text_outputs = text_outputs.strip()
                if text_outputs.endswith(stop_str):
                    text_outputs = text_outputs[:-len(stop_str)]
                text_outputs = text_outputs.strip()
